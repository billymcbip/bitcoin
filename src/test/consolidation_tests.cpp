...
BOOST_AUTO_TEST_CASE(many_prevouts)
{
    ...
    const CTxOut prevout0{COIN, spk1.script_pubkey}; // first, OP_CHECKCONSOLIDATION false
    const CTxOut prevout1{COIN, spk2.script_pubkey}; // first, OP_CHECKCONSOLIDATION false
    const CTxOut prevout2{COIN, spk2.script_pubkey}; // repeated, OP_CHECKCONSOLIDATION true
    const CTxOut prevout3{COIN, spk2.script_pubkey}; // repeated, OP_CHECKCONSOLIDATION true
    const CTxOut prevout4{COIN, spk1.script_pubkey}; // repeated, OP_CHECKCONSOLIDATION true
    const CTxOut prevout5{COIN, spk3.script_pubkey}; // first, OP_CHECKCONSOLIDATION false
